...
known in C++ as type-casting. There exist two main syntaxes for generic type-casting: functional and c-like:
 - double x = 10.3;
 - int y;
...
dynamic_cast, reinterpret_cast, static_cast and const_cast. Their format is to follow the new type enclosed between angle-brackets (<>) and immediately after, 
...
class Addition {
    int x,y;
  public:
    Addition (int a, int b) {cout<< "Addition constructor called.\n";x=a; y=b; }
    int result() { cout << "Result function called.\n"; return x+y;}
};
